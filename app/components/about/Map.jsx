...
export default function Map() {
  return (
    <div
            class=" items-center overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg max-w-6xl mx-auto bg-white my-6 font-[sans-serif]">
           
            <div class="z-10 relative h-[700px] max-md:min-h-[350px]">
